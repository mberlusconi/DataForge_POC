...
RESET_SQL = f"""
REVOKE WRITE ON STAGE POC_MEDALLION_CICD.BRONZE_PROD.RAW_FILES_STAGE FROM ROLE DBT_PIPELINE_DEVELOPER;
REVOKE READ ON STAGE POC_MEDALLION_CICD.BRONZE_PROD.RAW_FILES_STAGE FROM ROLE DBT_PIPELINE_DEVELOPER;

REVOKE WRITE ON STAGE POC_MEDALLION_CICD.BRONZE_UAT.RAW_FILES_STAGE FROM ROLE DBT_PIPELINE_DEVELOPER;
REVOKE READ ON STAGE POC_MEDALLION_CICD.BRONZE_UAT.RAW_FILES_STAGE FROM ROLE DBT_PIPELINE_DEVELOPER;

REVOKE WRITE ON STAGE POC_MEDALLION_CICD.BRONZE_DEV.RAW_FILES_STAGE FROM ROLE DBT_PIPELINE_DEVELOPER;
REVOKE READ ON STAGE POC_MEDALLION_CICD.BRONZE_DEV.RAW_FILES_STAGE FROM ROLE DBT_PIPELINE_DEVELOPER;
