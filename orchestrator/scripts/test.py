...
RESET_SQL = f"""
USE ROLE DBT_PIPELINE_DEPLOYER;
SHOW TABLES IN SCHEMA POC_MEDALLION_CICD.BRONZE_UAT;
SHOW TABLES IN SCHEMA POC_MEDALLION_CICD.SILVER_UAT;
SHOW VIEWS  IN SCHEMA POC_MEDALLION_CICD.SILVER_UAT;
SHOW TABLES IN SCHEMA POC_MEDALLION_CICD.GOLD_UAT;
"""
